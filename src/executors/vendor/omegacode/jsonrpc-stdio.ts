// Vendored from omegacode src/worker/jsonrpc-stdio.ts
...
export interface JsonRpcStdioOptions {
  ...
  stderrLimit?: number | undefined
  /** Inbound server-initiated request (the server expects a response by id). */
  onServerRequest?: ((id: JsonRpcId, method: string, params: unknown) => void) | undefined
  ...
  onProcessGone?: ((err: StdioTransportError) => void) | undefined
}
...
export class JsonRpcStdioClient {
  ...
  private readonly onServerRequest: ((id: JsonRpcId, method: string, params: unknown) => void) | undefined
  private readonly onNotification: ((method: string, params: unknown) => void) | undefined
  private readonly onGone: ((err: StdioTransportError) => void) | undefined
