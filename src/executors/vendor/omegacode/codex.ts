// Vendored from omegacode src/worker/codex.ts
...
import type { AgentResult, AgentSpec, AgentUsage } from "./types.js"
...
export interface CodexWorkerOpts {
  ...
  turnStallTimeoutMs?: number | undefined
}
...
export class CodexWorker implements Worker {
  ...
  private readonly spawnChild: SpawnChild | undefined
